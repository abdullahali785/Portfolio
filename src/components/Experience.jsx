        ...
        <div className="py-5 px-5 text-center bg-dark text-white"> 
            <div className="container py-5 bg-dark text-white"> 
                ...
                <p className="col-lg-8 mx-auto lead bg-dark text-white">
                    I diagnosed and resolved <span className="fw-bold bg-dark">hardware, software, and network</span> issues for students, faculty, and staff.<br></br>
                    Documented <span className="fw-bold bg-dark">350+</span> tickets demonstrating strong problem-solving and clear communication skills.<br></br>
                    Made <span className="fw-bold bg-dark">1000+</span> edits to the Technology Help Desk Wiki, a documentation of more than <span className="fw-bold bg-dark">850</span> pages.<br></br>
