    ...
    <div className="container px-4 pt-5" id="custom-cards"> 
        ...
        <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5"> 
            <div className="col"> 
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">AquaVitals</h3>
            ...
            <div className="col"> 
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">Abdullah's Books</h3> 
            ...
            <div className="col">
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">HTTP Server</h3>
            ...
            <div className="col"> 
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">Image Text Analyzer</h3>
            ...
            <div className="col"> 
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">Travel Tracker</h3> 
            ...
            <div className="col">
                <div className="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg zoom">
                    <div className="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1"> 
                        <h3 className="my-5 pt-5 display-6 lh-1 fw-bold text-dark">Fitness Made Feasible</h3>
                        <p className="text-dark mt-auto">A web app that locates nearby gyms and, based on the muscle you want to train, provides exercises with instructions and visual GIF demonstrations.</p> 
                    </div> 
                </div> 
            </div> 
        </div> 
