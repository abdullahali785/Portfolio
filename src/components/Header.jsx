        ...
        <div className="container mb-3"> 
            <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-4 mb-4"> 
                ...
                <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 gap-3"> 
                    <li><a href="#" className="nav-link px-2 font-weight-bold fs-5 fw-bolder nav-zoom" style={{ color: "#000080" }}>Experience</a></li>
                    <li><a href="#" className="nav-link px-2 font-weight-bold fs-5 fw-bolder nav-zoom" style={{ color: "#000080" }}>Projects</a></li>
                    <li><a href="#" className="nav-link px-2 font-weight-bold fs-5 fw-bolder nav-zoom" style={{ color: "#000080" }}>Skills</a></li>
                </ul> 
